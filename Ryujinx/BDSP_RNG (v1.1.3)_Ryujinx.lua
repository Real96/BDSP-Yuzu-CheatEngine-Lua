...
do
 ...
 seedAddressScan.firstScan(soExactValue, vtQword, 0, "04B4E97830444F4D", "", 0, 0x7FFFFFFFFFFF,
...
local function getPlayerPrefsProviderAddr()
 local playerPrefsProviderInstanceAddr = readQword(mainAddr + 0x4E853F0)
...
local stateAddr = readQword(mainAddr + 0x4FB2050) + baseAddr
